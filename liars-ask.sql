...
--
-- Host: localhost
-- Generation Time: Oct 26, 2019 at 01:53 PM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `deleteQuestion` (`idQues` INT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `requestRelatedQuestionId` (`quesId` INT)  BEGIN
	SELECT * FROM questions WHERE id = quesId;
END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `updateUserInfoAndRelatedAnswers` (IN `fullname` VARCHAR(225), IN `photo` VARCHAR(225), IN `userId` INT)  BEGIN
    ...
    UPDATE answers SET fullname=fullname , photo=photo WHERE owner=userId;
END$$
...
(12, 'SQL supports qualifying a column by prefixing the reference with either the full table name:\n\n```\nSELECT tbl_names.id, tbl_section.id, name, section\nFROM tbl_names\nJOIN tbl_section ON tbl_section.id = tbl_names.id \n```', 2, ' 2 5', '2019-10-19 03:46:36', 'danghuunghia2712@gmail.com', 'dhnghia', 'https://res.cloudinary.com/ddrw0yq95/image/upload/v1571933205/lqjd6oysxxvv8wjonwzz.jpg'),
(13, 'In your `SELECT` statement you need to preface your id with the table you want to choose it from.\n\n```\nSELECT tbl_names.id, name, section \nFROM tbl_names\nINNER JOIN tbl_section \n   ON tbl_names.id = tbl_section.id\n```\n\nOR\n\n```\nSELECT tbl_section.id, name, section \nFROM tbl_names\nINNER JOIN tbl_section \n   ON tbl_names.id = tbl_section.id\n```', 2, '', '2019-10-19 04:14:04', 'danghuunghia2712@gmail.com', 'dhnghia', 'https://res.cloudinary.com/ddrw0yq95/image/upload/v1571933205/lqjd6oysxxvv8wjonwzz.jpg'),
(14, 'You would do that by providing a fully qualified name, e.g.:\n\n```\nSELECT tbl_names.id as id, name, section FROM tbl_names, tbl_section WHERE tbl_names.id = tbl_section.id\n```', 2, '', '2019-10-19 04:50:30', 'danghuunghia2712@gmail.com', 'dhnghia', 'https://res.cloudinary.com/ddrw0yq95/image/upload/v1571933205/lqjd6oysxxvv8wjonwzz.jpg'),
(15, 'What you are probably really wanting to do here is use the union operator like this:\n\n```\n(select ID from Logo where AccountID = 1 and Rendered = \'True\')\n  union\n  (select ID from Design where AccountID = 1 and Rendered = \'True\')\n  order by ID limit 0, 51\n```\n\n![ruby](https://res.cloudinary.com/ddrw0yq95/image/upload/v1571423572/mcfp0fgknyefr9ohed00.png)\n\nHere\'s the docs for it [https://dev.mysql.com/doc/refman/5.0/en/union.html](https://dev.mysql.com/doc/refman/5.0/en/union.html)\n\n', 5, '', '2019-10-19 05:20:01', 'lars27399@gmail.com', 'blue liars', 'https://res.cloudinary.com/ddrw0yq95/image/upload/v1571422910/g4ozyhp9p4imvcrfk859.jpg'),
(16, 'Just add this: \n\n```\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n```', 2, '', '2019-10-22 09:17:06', 'danghuunghia2712@gmail.com', 'dhnghia', 'https://res.cloudinary.com/ddrw0yq95/image/upload/v1571933205/lqjd6oysxxvv8wjonwzz.jpg'),
(17, 'test answer', 2, '', '2019-10-22 09:19:11', 'danghuunghia2712@gmail.com', 'dhnghia', 'https://res.cloudinary.com/ddrw0yq95/image/upload/v1571933205/lqjd6oysxxvv8wjonwzz.jpg'),
(18, 'another answer\r\n```\r\nlet clearText = () => {\r\n    console.log(\"clear text editor here\");\r\n}\r\n```\r\n![image](https://res.cloudinary.com/ddrw0yq95/image/upload/v1571423572/mcfp0fgknyefr9ohed00.png)', 2, '', '2019-10-22 09:20:24', 'danghuunghia2712@gmail.com', 'dhnghia', 'https://res.cloudinary.com/ddrw0yq95/image/upload/v1571933205/lqjd6oysxxvv8wjonwzz.jpg'),
(19, 'I\'ve seen it done in a kind of iffy, but pretty reliable way. Basically, an element is set to use a specific font and a string is set to that element. If the font set for the element does not exist, it takes the font of the parent element. So, what they do is measure the width of the rendered string. If it matches what they expected for the desired font as opposed to the derived font, it\'s present. This won\'t work for monospaced fonts.\n\nHere\'s where it came from: [Javascript/CSS Font Detector (ajaxian.com; 12 Mar 2007)](http://ajaxian.com/archives/javascriptcss-font-detector)', 2, ' 5 2 6', '2019-10-24 13:48:25', 'danghuunghia2712@gmail.com', 'dhnghia', 'https://res.cloudinary.com/ddrw0yq95/image/upload/v1571933205/lqjd6oysxxvv8wjonwzz.jpg'),
(20, 'I wrote a simple JavaScript tool that you can use it to check if a font is installed or not.\nIt uses simple technique and should be correct most of the time.\n\n(jFont Checker)[https://github.com/derek1906/jFont-Checker/] on github', 2, ' 5', '2019-10-24 13:53:18', 'danghuunghia2712@gmail.com', 'dhnghia', 'https://res.cloudinary.com/ddrw0yq95/image/upload/v1571933205/lqjd6oysxxvv8wjonwzz.jpg'),
(23, 'There is a simple solution - just use `element.style.font`:\n\n```\nfunction getUserBrowsersFont() {\n    var browserHeader = document.getElementById(\'header\');\n    return browserHeader.style.font;\n}\n```\n\nThis function will exactly do what you want. On execution It will return the font type of the user/browser. Hope this will help.', 5, ' 2 5', '2019-10-24 14:11:56', 'lars27399@gmail.com', 'blue liars', 'https://res.cloudinary.com/ddrw0yq95/image/upload/v1571422910/g4ozyhp9p4imvcrfk859.jpg'),
(24, 'Your problem is referencing the same msg object from async code. The foreach completes before the sendMail would send out the emails.\n\nSo msg.to wil be the last item from the maiilist object.\n\nTry to clone/copy msg inside maillist foreach, or just move msg definition to there :\n\n```\nmaillist.forEach(function (to, i , array) {\n\n\n  var msg = {\n        from: \"******\", // sender address\n        subject: \"Hello ✔\", // Subject line\n        text: \"Hello This is an auto generated Email for testing  from node please ignore it  ✔\", // plaintext body\n        cc: \"*******\"    \n        //  html: \"<b>Hello world ✔</b>\" // html body\n    }\n  msg.to = to;\n\n  smtpTransport.sendMail(msg, function (err) {\n       console.log(err)\n  })\n```', 5, '2 7 6', '2019-10-25 06:46:23', 'lars27399@gmail.com', 'blue liars', 'https://res.cloudinary.com/ddrw0yq95/image/upload/v1571422910/g4ozyhp9p4imvcrfk859.jpg'),
(25, 'nodemailer (v2.4.2) [docs](https://github.com/nodemailer/nodemailer#e-mail-message-fields) say:\n\n> `to` - Comma separated list or an array of recipients e-mail addresses that will appear on the To: field\n\nSo you can just do:\n\n```\nvar maillist = [\n  \'****.sharma3@****.com\',\n  \'****.bussa@****.com\',\n  \'****.gawri@****.com\',\n];\n\nvar msg = {\n    from: \"******\", // sender address\n    subject: \"Hello ✔\", // Subject line\n    text: \"Hello This is an auto generated Email for testing  from node please ignore it  ✔\", // plaintext body\n    cc: \"*******\",\n    to: maillist\n}\n```', 2, ' 6', '2019-10-25 10:49:15', 'danghuunghia2712@gmail.com', 'dhnghia', 'https://res.cloudinary.com/ddrw0yq95/image/upload/v1571933205/lqjd6oysxxvv8wjonwzz.jpg'),
(26, 'A good way to do it asynchronously would be to use the each function in the async module: [https://caolan.github.io/async/docs.html#each](https://caolan.github.io/async/docs.html#each)\n\n```\nvar async = require(\"async\");\n\nasync.each(maillist, function(to, callback){\n\n    msg.to = to;\n\n    smtpTransport.sendMail(msg, function (err) {\n        if (err) { \n            console.log(\'Sending to \' + to + \' failed: \' + err);\n            callback(err);\n        } else { \n            console.log(\'Sent to \' + to);\n            callback();\n        }\n    });\n}, function(err){\n    if(err){\n        console.log(\"Sending to all emails failed:\" + err);\n    }\n\n    //Do other stuff or return appropriate value here\n});\n```', 6, '', '2019-10-25 11:00:58', 'nghiab1706729@student.ctu.edu.vn', 'Alagi', 'https://res.cloudinary.com/ddrw0yq95/image/upload/v1572001368/wwq264ntq828htdhkmrd.jpg');
...
(1, 'lalatina@gmail.com', 'blue', '95d0d6ab81bde91365520a5f54f888bb5ea65ca7d1506faeb31291fc519284d1', 't630fd1d', NULL, NULL, 'https://res.cloudinary.com/ddrw0yq95/image/upload/v1571422910/g4ozyhp9p4imvcrfk859.jpg', 1, NULL, NULL, 1, 0, NULL),
(2, 'danghuunghia2712@gmail.com', 'dhnghia', '45b61a13748390082a2b1121d6db185dddd0dc36d469ac55a0ac58db8d8db531', 'tyz8ldwy', '2019-10-17 17:17:28', NULL, 'https://res.cloudinary.com/ddrw0yq95/image/upload/v1571933205/lqjd6oysxxvv8wjonwzz.jpg', 1, '```\nconst { quotes, bio, id } = props.userPayload;\n    \nconst [fquotes, setQuotes] = useState(quotes);\nconst [showNotify, setShowNotify] = useState(\"\");\n\n```', 'Being alone is not synonymous with being lonely', 2, 0, NULL),
(5, 'lars27399@gmail.com', 'blue liars', '4be527749eb08467a825e63ff40eb622d683866d2562d29f8cb2cfc0a936af1c', 'ykxf2fkl', '2019-10-18 18:26:21', NULL, 'https://res.cloudinary.com/ddrw0yq95/image/upload/v1571422910/g4ozyhp9p4imvcrfk859.jpg', 1, NULL, NULL, 1, 0, NULL),
